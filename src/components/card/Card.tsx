...
const Card = ({
  ...
  return (
    <div className="px-6 pt-6 shadow-2xl bg-white">
      <Image src={image.src} alt={image.alt} width={336} height={240} />
      <div className="py-8">
        ...
        <div className="max-w-[336px] pt-3 font-inter text-base font-normal leading-6 text-left text-[#667085]">
          {description}
        </div>
        <div className="pt-10">
